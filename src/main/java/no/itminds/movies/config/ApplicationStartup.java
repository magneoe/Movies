...
//					.id(1L)
//					.title("Pulp fiction")
//					.releaseDate(Date.valueOf("1994-10-21"))
//					.year("1999")
//					.created(Date.valueOf(LocalDate.now()))
//					.duration("120")
//					.genres(Arrays.asList(action, horror))
//					.ratings(Arrays.asList(rating1))
//					.plot("Everyone kills")
//					.posterUrl(
...
//			MovieBuilder movieBuilder = new MovieBuilder();
//			Movie comingToAmerica = movieBuilder.actors(Arrays.asList(actor2))
//					.id(2L)
//					.averageRating(new Float(5.0))
//					.title("Coming to America")
//					.releaseDate(Date.valueOf("1988-10-21"))
//					.created(Date.valueOf(LocalDate.now()))
//					.duration("90")
//					.genres(Arrays.asList(comedy))
//					.year("2018")
...
//			MovieBuilder movieBuilder = new MovieBuilder();
//			Movie killBill = movieBuilder.actors(Arrays.asList(actor3))
//					.id(3L)
//					.averageRating(new Float(5.0)).title("Kill Bill")
//					.releaseDate(Date.valueOf("2003-10-21"))
//					.created(Date.valueOf(LocalDate.now()))
//					.duration("180")
//					.year("2019")
//					.genres(Arrays.asList(action, comedy))
//					.ratings(Arrays.asList(rating3)).plot("Very funny")
//					.posterUrl(
